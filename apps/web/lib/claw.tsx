...
// Legacy export — used by site-header.tsx and mobile-nav.tsx inline SVGs
// Now renders full AL logo as a compound path in 500x500 viewbox
export const CLAW_VIEWBOX = "0 0 500 500";

// AL logo as React component — circle + bold AL text as paths
...
// For OG images (Satori) — no <text>, only paths
